<?php
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, $insert) or die("echo '<script type='text/javascript'>alert('Erro ao cadastrar veículo!');window.location.href='cadastro-veiculos.php';</script>';");
